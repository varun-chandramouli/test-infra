...
REPO=${NEPHIO_REPO:-$(get_metadata nephio-test-infra-repo "https://github.com/varun-chandramouli/test-infra.git")}
BRANCH=${NEPHIO_BRANCH:-$(get_metadata nephio-test-infra-branch "iosmcn")}
